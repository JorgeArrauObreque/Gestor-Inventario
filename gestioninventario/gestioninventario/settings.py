...
SECRET_KEY = 'django-insecure-s8=_p6@b34#yss3pzsnyp9%*!!and8-!!fn0p4z(b=9-eg*$87'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'gestioninventario/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(BASE_DIR,"gestioninventario/static")]
